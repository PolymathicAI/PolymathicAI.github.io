...
We are concentrating our efforts on the fundamentals of this space, and have thus far published research on key architectural components, from adapting language models for numerical data[[1]](/blog/xval) to demonstrating transferability of surrogate models trained on diverse physical systems[[2]](/blog/mpp) to learning shared embeddings for multi-modal scientific data[[3]](/blog/astroclip).
We encourage you to find out more at [this link](/blog).
